...
生物の法的・保全上の位置付けと、自治体が求める通報・捕獲・捕殺などの組み合わせは、事実だけを[生物ステータス・制度台帳](docs/species-status-registry.md)で管理します。全国の特定外来生物162指定と検証済みの自治体制度を収録し、公式ソースの更新は定期workflowで検知して人手で確認してから反映します。
